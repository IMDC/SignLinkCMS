...
<div class="centeralign">
   <p><?php echo $_POST['login'] . " " . $_POST['password'] ?></p>
   
   <h3>Please login below.</h3>

   <link rel="stylesheet" href="../css/adminform.css" type="text/css" />
   <form action="login.php" method="POST" name="admin-login-form" id="admin-login-form" class="centeralign">
      <input type="hidden" name="password_hidden" value="" />
      <fieldset>
         <legend>Login Information</legend>
         <ol>
            <li>
               <label for="login"><img src="../images/user_med.png" alt="" title="Login name" class="inlineVertMid" /></label>
               <input name="login" type="text" id="login" value="" />
            </li>
            <li>
               <label for="password"><img src="../images/key3.png" alt="" title="User password" class="inlineVertMid" /></label>
               <input name="password" type="password" id="pswd" value="" />
            </li>
         </ol>
      </fieldset>
      <p><input type="submit" id="loginsubmit" value="Login" class="submitBtn" /></p>
      ...
      <div style="text-align:center; padding-top:1em;padding-bottom:2em;">
         <input type="submit" name="submit" value="Submit" class="submitBtn" />
      </div>
       -->
   </form>
   <div class="">
      <a href="../index.php"><img src="../images/arrow_left_32.png" alt="" class="inlineVertMid" />&nbsp;Back to main site</a>
   </div>
</div>

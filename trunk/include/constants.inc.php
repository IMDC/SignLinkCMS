...
$filetypes_video = array("avi", "mpeg", "mpg", "wma", "mov", "flv");
...
$vlog_pages = array("vlog_comment.php", "vlog_entry_create.php", "vlog_entry_edit.php", "vlog_entry_view.php", "vlog_entries.php", "vlogs.php");

...
<div id="container">
	...
	<div id="login-area">
		...
		<form action="login.php" method="POST" id="loginform" name="form">
			...
			<label for="login"><img src="images/user_med.png" alt="login" title="login" class="inlineVertMid" /></label> <input name="login" type="text" id="login" value="<?php echo $_SERVER['login']; ?>" style="width:55%;font-size:1.3em;font-family:arial,verdana,sans-serif" /><br />
			<label for="pswd"><img src="images/key3.png" alt="password" title="password" class="inlineVertMid" /></label> <input name="password" type="password" id="pswd" value="" style="width:55%; font-size:smaller;" /><br />
         <!--<div id="login-button-container"><img src="images/login_32.png" name="submitImg" alt="" class="inlineVertMid" style="margin-left:auto;margin-right:auto;margin-top:5px;" />-->
         <div id="login-button-container"><input type="image" src="images/login_32.png" name="submitImg" alt="" class="inlineVertMid" style="margin-left:auto;margin-right:auto;margin-top:5px;" />
...
<!--            <hr style="margin-top: 8px; width: 80%; height:2px; color: #0066FF;" />-->
  ...
  <div id="new-logo-container">
    <img src="images/newlogoidea.png" />
  </div>
